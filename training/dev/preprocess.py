...
def transform_order_data():
	order_df = pd.read_csv(filepath="../../database/data_order.csv", parse_dates=["CHECKOUT_DATE"])
...
def transform_product_data():
	product_df = pd.read_csv(filepath='../../database/data_metadata_product.csv')
...
def transform_store_data():
	store_df = pd.read_csv(filepath='../../database/data_metadata_store.csv')
